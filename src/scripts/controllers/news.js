...
angular.module('app')
    .controller('newsCtrl', ['$rootScope', '$scope', 'bridge', 'crud', ($rootScope, $scope, bridge, crud) => {
        ...
        $scope.getNews = (...para) => {
            ...
            crud.$http({
                    method: 'GET',
                    url: path + 'sho/109-35?&channelId=&channelName=' + encodeURIComponent($scope.news.selectedChanelName) + '&maxResult=15&needAllList=0&needContent=0&needHtml=0&page=1&showapi_appid=33446&&title=&showapi_sign=d3f5fd95469849eb859a84e27023fa00&',
