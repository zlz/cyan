(function (window, Raphael) {
    var ob = function (para) {
        ...
        if (para.type === "full") {
            torus.bgPath = torus.paper.path("M" + torus.x0 + "," + torus.y0 + "A" + torus.r + "," + torus.r + ",0,1,1," + (torus.halfDime + torus.r * Math.cos(2 * torus.PI * 0.74999)) + "," + (torus.halfDime + torus.r * Math.sin(2 * torus.PI * 0.74999)));
            torus.si = window.setInterval(function () {
                if (torus.per <= para.perc) {
                    ...
                    torus.path = torus.paper.path("M" + torus.x0 + "," + torus.y0 + "A" + torus.r + "," + torus.r + ",0," + (torus.per > 0.5 ? 1 : 0) + ",1," + torus.x + "," + torus.y);
                    torus.path.attr({
                        "stroke": para.fgColor,
            ...
            torus.bgPath = torus.paper.path("M" + (torus.halfDime + torus.r * Math.cos(0)) + "," + (torus.halfDime + torus.r * Math.sin(0)) + "A" + torus.r + "," + torus.r + ",0,1,1," + (torus.halfDime + torus.r * Math.cos(2 * torus.PI * 0.5)) + "," + (torus.halfDime + torus.r * Math.sin(2 * torus.PI * 0.5)));
            ...
            torus.path = torus.paper.path("M" + (torus.halfDime + torus.r * Math.cos(0)) + "," + (torus.halfDime + torus.r * Math.sin(0)) + "A" + torus.r + "," + torus.r + ",0,0,1," + torus.x + "," + torus.y);
            torus.path.attr({
                "stroke": para.fgColor,
                "stroke-width": para.width
            });
